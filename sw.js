...
var CACHE_NAME = 'alpha-finder-v3';
...
self.addEventListener('fetch', function(event){
  ...
  // Cross-origin requests (e.g. the live gold-price API) must always go
  // straight to the network -- never served from/written to this cache,
  // otherwise "live" price polling would silently freeze on the first
  // cached response instead of refreshing.
  try{
